...
namespace DDMedi.Test.Helper
{
    public static class DecoratorHelper
    {
        ...
        public static ISetup<IAsyncDecorator<TInputs, TOutput>, Task<TOutput>> SetUpProcessAsyncAny<TInputs, TOutput>(this Mock<IAsyncDecorator<TInputs, TOutput>> Decorator) where TInputs : class
        ...
        public static ISetup<IAsyncDecorator<TInputs>, Task> SetUpProcessAsyncAny<TInputs>(this Mock<IAsyncDecorator<TInputs>> Decorator) where TInputs : class
        => Decorator.Setup(item => item.ProcessAsync(It.IsAny<TInputs>(), It.IsAny<IAsyncDecoratorContext>(), It.IsAny<CancellationToken>()));
        public static ISetup<IDecorator<TInputs, TOutput>, TOutput> SetUpProcessAny<TInputs, TOutput>(this Mock<IDecorator<TInputs, TOutput>> Decorator) where TInputs : class
        => Decorator.Setup(item => item.Process(It.IsAny<TInputs>(), It.IsAny<IDecoratorContext<TOutput>>()));
        public static ISetup<IDecorator<TInputs>> SetUpProcessAny<TInputs>(this Mock<IDecorator<TInputs>> Decorator) where TInputs : class
        ...
        public static void VerifyProcessAsyncAny<TInputs, TOutput>(this Mock<IAsyncDecorator<TInputs, TOutput>> decorator, Times times) where TInputs : class
        ...
        public static void VerifyProcessAsyncAny<TInputs>(this Mock<IAsyncDecorator<TInputs>> decorator, Times times) where TInputs : class
        ...
        public static void VerifyProcessAny<TInputs>(this Mock<IDecorator<TInputs>> decorator, Times times) where TInputs : class
        => decorator.Verify(item => item.Process(It.IsAny<TInputs>(), It.IsAny< IDecoratorContext>()), times);
        public static void VerifyProcessAny<TInputs, TOutput>(this Mock<IDecorator<TInputs, TOutput>> decorator, Times times) where TInputs : class
